...
namespace RPRZadaca1
{
    ...
    public class Student : Clan
    {
        ...
        public Student(string pime, string pprezime, string pmaticni_broj, DateTime pdatum_rodjenja, string pkomentar, int pbroj_indeksa, string m, string korisnicko, string lozinka, Image sl) :
